...
Before any browser exploration, test generation, debugging, or selector fixing, read and follow `.claude/skills/playwright-cli/SKILL.md`.

Do not generate or edit selectors until the page has been inspected with browser snapshot / Playwright CLI tools.
